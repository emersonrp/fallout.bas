...
45050 GOSUB 49040
45060 RETURN
46000 REM -- subroutine to initialize the list of hex addresses
46010 RESTORE 46030
...
46020 DIM HEXADDRS!(7)
46030 DATA 48304,49968,64198,20992,63056,20464,62720
46040 FOR J = 1 TO 7
46050   READ HEXADDRS!(J)
46055   IF HEXADDRS!(J) > 32767 THEN HEXADDRS!(J) = HEXADDRS!(J) - 65536
46060 NEXT J
46070 RETURN
...
49060 PRINT @ PALOC, ">" ; STRING$(WORDLENGTH%, " ");: ' Clear the line completely first
49070 PRINT @ PALOC, ">" ; GUESS$;
49080 RETURN
