...
1520 LSIDEWORDCOUNT% = INT(WORDLISTLENGTH% / 2)
1530 RSIDEWORDCOUNT% = INT(WORDLISTLENGTH% / 2)
1540 IF (WORDLISTLENGTH% - (INT(WORDLISTLENGTH% / 2) * 2)) = 1 THEN LSIDEWORDCOUNT% = LSIDEWORDCOUNT% + 1
...
49030 NEXT
49040 PALOC = 22*80 + 41
49050 PRINT @ PALOC, ">" ; GUESS$;
49060 RETURN
